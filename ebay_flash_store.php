...
define('EBAY_FLASH_STORE_PLUGIN_URL', plugin_dir_url( __FILE__ ));
define('EBAY_FLASH_STORE_PLUGIN_PATH', dirname( __FILE__ ));
define('EBAY_FLASH_STORE_PLUGIN_VAR_NAME', "ebay_flash_store_configuration");

function ebay_flash_store_get_proxy_url(){
  return "http://www.edeetion.com/ebayproxy/index.js.php?";
